        ...
        <v-container class="d-flex flex-column h-100">
          <div style="flex: 1; overflow-y: auto">
            <v-list v-for="(productCart, index) in cart" :key="index">
              <v-list-item class="my-4">
                ...
                <span class="font-weight-medium text-primary text-h6 mt-2"
          ...
          <div>
            ...
            <div class="d-flex justify-space-between mt-5">
              <span class="font-weight-medium text-grey-darken-3 text-h5"
                >Total</span
              >
            ...
            <v-checkbox color="primary" value="primary" hide-details>
              <template v-slot:label>
                ...
                <span class="font-weight-bold ms-1">terms and conditions</span>
              </template>
            </v-checkbox>
            <v-btn
              variant="flat"
